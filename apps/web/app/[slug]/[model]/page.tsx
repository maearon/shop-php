...
export default function ProductDetailPage() {
  ...
  const product = soccerShoesData.find((p) => p.modelNumber === params.model) || soccerShoesData[0]
            ...
            >
              <div className="space-y-6 lg:max-w-lg">
                ...
                <div className="flex gap-4">
                  <MainButton 
                    theme="black" shadow={true} fullWidth={true}
                    onClick={handleAddToBag}
                    className="flex-1 bg-black text-white hover:bg-gray-800 py-4 text-base font-bold shadow-[0_4px_0_0_rgba(0,0,0,0.3)] active:shadow-none active:translate-y-1 transition-all duration-150 rounded-none flex items-center justify-center"
                  >
                    ADD TO BAG
                  ...
                  <button
                    ...
                    className="w-12 h-12 border border-black rounded-none flex items-center justify-center hover:bg-black hover:text-white transition-colors"
                  >
